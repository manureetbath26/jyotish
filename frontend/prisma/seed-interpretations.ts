/**
 * Seed script: populates the Interpretation table with all karaka interpretation data.
 *
 * Run:  npx tsx prisma/seed-interpretations.ts
 *
 * Categories:
 *   chara_role          — 7 rows  (key1 = role id, key2 = null)
 *   chara_by_planet     — 56 rows (key1 = role id, key2 = planet)
 *   chara_lordship      — 84 rows (key1 = role id, key2 = house number as string)
 *   naisargika          — 9 rows  (key1 = planet, key2 = null)
 *   naisargika_in_house — 108 rows (key1 = planet, key2 = house number as string)
 */
...
const CHARA_KARAKA_ROLES = [
  {
    id: "AK", name: "Atmakaraka", shortName: "AK", meaning: "Soul Significator",
  ...
  {
    id: "AmK", name: "Amatyakaraka", shortName: "AmK", meaning: "Career / Advisor Significator",
  ...
  {
    id: "BK", name: "Bhratrikaraka", shortName: "BK", meaning: "Siblings / Courage Significator",
  ...
  {
    id: "MK", name: "Matrikaraka", shortName: "MK", meaning: "Mother / Happiness Significator",
  ...
  {
    id: "PK", name: "Putrakaraka", shortName: "PK", meaning: "Children / Creativity Significator",
  ...
  {
    id: "GK", name: "Gnatikaraka", shortName: "GK", meaning: "Obstacles / Enemies Significator",
  ...
  {
    id: "DK", name: "Darakaraka", shortName: "DK", meaning: "Spouse / Partnership Significator",
...
const CHARA_KARAKA_BY_PLANET: Record<string, Record<string, string>> = {
  AK: {
...
const CHARA_KARAKA_LORDSHIP: Record<string, Record<number, string>> = {
  AK: {
    1: "Your Atmakaraka rules the 1st house — your soul purpose and physical identity are inseparable. Your body, appearance, and health are direct instruments of your karmic evolution.",
    2: "Your Atmakaraka rules the 2nd house — the soul's lessons are deeply intertwined with wealth, family lineage, and the power of speech. How you earn and what you value define your spiritual path.",
    3: "Your Atmakaraka rules the 3rd house — courage, self-expression, and communication are soul-level themes. Writing, media, or entrepreneurial initiative may be part of your karmic mission.",
    4: "Your Atmakaraka rules the 4th house — the soul's evolution is tied to mother, home, emotional peace, and education. Finding or creating a true home is a karmic imperative.",
    5: "Your Atmakaraka rules the 5th house — creativity, children, and intelligence are channels for your soul's expression. Past-life creative or teaching karma is ripening in this life.",
    6: "Your Atmakaraka rules the 6th house — the soul evolves through overcoming enemies, disease, and debts. Service, healing, or legal work may be your karmic calling.",
    7: "Your Atmakaraka rules the 7th house — partnerships and marriage are the soul's primary classroom. Your deepest spiritual growth comes through learning to relate, compromise, and love.",
    8: "Your Atmakaraka rules the 8th house — transformation, crisis, and hidden knowledge are woven into your soul's DNA. You are here to die to old selves repeatedly and emerge wiser.",
    9: "Your Atmakaraka rules the 9th house — dharma, philosophy, and higher truth are your soul's natural domain. Teaching, pilgrimage, and guru relationships define your life path.",
    10: "Your Atmakaraka rules the 10th house — career and public duty are soul-level imperatives. Your work in the world is not just livelihood but spiritual practice.",
    11: "Your Atmakaraka rules the 11th house — the soul's purpose unfolds through community, large networks, and the fulfilment of collective ambitions. Impact at scale matters.",
    12: "Your Atmakaraka rules the 12th house — spiritual liberation, foreign experiences, and surrender of ego are embedded in your soul's charter. Letting go is your greatest act of courage.",
  },
  AmK: {
    1: "Your Amatyakaraka rules the 1st house — your career is deeply personal; you are your own brand. Professional success comes through the strength of your individual personality and initiative.",
    2: "Your Amatyakaraka rules the 2nd house — career connects directly to wealth, speech, and family resources. You may earn through family business, banking, food, or eloquent communication.",
    3: "Your Amatyakaraka rules the 3rd house — career thrives through writing, media, sales, or entrepreneurial hustle. Your professional edge is communication and self-driven initiative.",
    4: "Your Amatyakaraka rules the 4th house — career connects to real estate, education, automobiles, or your homeland. Working from home or building property-related businesses is natural.",
    5: "Your Amatyakaraka rules the 5th house — creative industries, education, entertainment, or speculative ventures are your professional domain. Teaching and guiding youth may define your career.",
    6: "Your Amatyakaraka rules the 6th house — you excel in competitive, service-oriented, or healing professions. Medicine, law, military, or crisis management suit your professional nature.",
    7: "Your Amatyakaraka rules the 7th house — partnerships are central to your career. Consulting, client-facing work, foreign trade, or joint ventures drive your professional growth.",
    8: "Your Amatyakaraka rules the 8th house — career may involve research, insurance, investigation, occult sciences, or managing others' resources. You thrive in fields others find intimidating.",
    9: "Your Amatyakaraka rules the 9th house — higher education, law, publishing, religion, or international business define your career. A mentor or father figure shapes your professional path.",
    10: "Your Amatyakaraka rules the 10th house — exceptionally strong for career. Professional authority, government positions, and public leadership are natural. Career is a central life theme.",
    11: "Your Amatyakaraka rules the 11th house — professional gains come through large networks and organisations. Your career generates substantial income and fulfils long-held ambitions.",
    12: "Your Amatyakaraka rules the 12th house — career may involve foreign countries, spiritual institutions, hospitals, or behind-the-scenes work. International professional connections are especially fruitful.",
  },
  DK: {
    1: "Your Darakaraka rules the 1st house — marriage profoundly shapes your identity. Your spouse becomes a mirror for your own personality; who you marry changes who you become.",
    2: "Your Darakaraka rules the 2nd house — your spouse is directly connected to your wealth and family. Marriage brings financial change — the partner may come from a wealthy family or significantly impact your earnings.",
    3: "Your Darakaraka rules the 3rd house — your spouse is communicative, courageous, and may be met through media, travel, or sibling connections. Marriage stimulates your self-expression and initiative.",
    4: "Your Darakaraka rules the 4th house — marriage is closely tied to home, emotional security, and mother. Your spouse creates or transforms your domestic life. Property matters are linked to partnership.",
    5: "Your Darakaraka rules the 5th house — deep romantic love precedes marriage. Your spouse connects to your creativity and children. The relationship is playful, intellectually stimulating, and creatively inspiring.",
    6: "Your Darakaraka rules the 6th house — marriage involves working through conflicts, health matters, or service-related themes. The partnership strengthens through overcoming obstacles together rather than avoiding them.",
    7: "Your Darakaraka rules the 7th house — marriage is the single most defining relationship in your life. Your spouse is a true partner in every sense; the relationship defines your public identity and social standing.",
    8: "Your Darakaraka rules the 8th house — marriage is transformative, intense, and deeply karmic. Joint finances, inheritance, and shared secrets are significant themes. The relationship changes you at the deepest level.",
    9: "Your Darakaraka rules the 9th house — your spouse brings fortune, wisdom, or connection to a different philosophy or culture. Marriage improves your luck and expands your worldview. Partner may be from abroad.",
    10: "Your Darakaraka rules the 10th house — your spouse directly influences your career and public reputation. Marriage elevates your professional standing, or your partner is career-driven and publicly prominent.",
    11: "Your Darakaraka rules the 11th house — your spouse brings social connections, financial gains, and helps fulfil your ambitions. The marriage is friendship-based with shared goals and community involvement.",
    12: "Your Darakaraka rules the 12th house — your spouse may be from a foreign land or spiritually inclined. Marriage involves sacrifice, travel, or periods of separation. The relationship deepens through surrender and spiritual connection.",
  },
  BK: {
    1: "Your Bhratrikaraka rules the 1st house — your courage and initiative are core personality traits. Siblings shape who you are. Your willpower and physical energy define your life approach.",
    2: "Your Bhratrikaraka rules the 2nd house — siblings are connected to family wealth. Your courage expresses through bold financial decisions and commanding speech.",
    3: "Your Bhratrikaraka rules the 3rd house — exceptionally strong for courage and siblings. Communication, entrepreneurship, and self-made achievement are powerful themes in your life.",
    4: "Your Bhratrikaraka rules the 4th house — courage applies to domestic matters and property. Siblings connect to your home life. Bold moves in real estate or education are favoured.",
    5: "Your Bhratrikaraka rules the 5th house — courage in creative and romantic pursuits. Siblings connect to your children or creative work. Bold approach to speculation and education.",
    6: "Your Bhratrikaraka rules the 6th house — your willpower is directed at defeating enemies and overcoming obstacles. Siblings may face conflicts. Courage in legal, medical, or competitive fields.",
    7: "Your Bhratrikaraka rules the 7th house — courage in partnerships and marriage. Siblings influence your relationships. Bold, direct approach to business deals and contractual negotiations.",
    8: "Your Bhratrikaraka rules the 8th house — courage in facing crises and transformation. Siblings connect to hidden matters or inheritance. Your willpower is tested through deep life changes.",
    9: "Your Bhratrikaraka rules the 9th house — courage in pursuing dharma and higher truth. Siblings are fortunate or philosophically inclined. Bold initiative in education, teaching, or spiritual pursuits.",
    10: "Your Bhratrikaraka rules the 10th house — courage and initiative drive your career. Siblings influence your professional life. You are bold and action-oriented in your public role.",
    11: "Your Bhratrikaraka rules the 11th house — courage brings gains. Siblings are connected to your social network and income. Ambitious initiative leads to fulfilment of desires.",
    12: "Your Bhratrikaraka rules the 12th house — courage directed toward spiritual or foreign pursuits. Siblings may be abroad. Your initiative works best in secluded, international, or spiritual contexts.",
  },
  MK: {
    1: "Your Matrikaraka rules the 1st house — mother profoundly shapes your personality and physical constitution. Your emotional nature is the most visible aspect of who you are.",
    2: "Your Matrikaraka rules the 2nd house — mother connects to family wealth and values. Emotional security comes through financial stability. Nurturing speech and family-oriented values.",
    3: "Your Matrikaraka rules the 3rd house — mother is courageous and communicative. Emotional growth through self-effort and creative expression. Siblings and mother share a close bond.",
    4: "Your Matrikaraka rules the 4th house — deeply auspicious. Mother is central to your life. Home, property, vehicles, and emotional happiness are strongly favoured themes.",
    5: "Your Matrikaraka rules the 5th house — mother connects to your creativity and children. Emotional fulfilment through creative expression, romance, and intellectual pursuits.",
    6: "Your Matrikaraka rules the 6th house — mother may face health challenges or carry heavy service burdens. Emotional growth comes through overcoming obstacles and serving others.",
    7: "Your Matrikaraka rules the 7th house — mother influences your choice of partner and the quality of your marriage. Emotional security is deeply tied to the success of your partnerships.",
    8: "Your Matrikaraka rules the 8th house — transformative relationship with mother. Emotional life involves deep, intense experiences. Inheritance or hidden family matters are significant.",
    9: "Your Matrikaraka rules the 9th house — mother is wise, dharmic, or spiritually inclined. Emotional peace comes through philosophical understanding and connection to higher truth.",
    10: "Your Matrikaraka rules the 10th house — mother influences your career and public standing. Emotional fulfilment is tied to professional achievement and public recognition.",
    11: "Your Matrikaraka rules the 11th house — mother connects to your social network and gains. Emotional security through community involvement and the fulfilment of ambitions.",
    12: "Your Matrikaraka rules the 12th house — mother may live abroad or be spiritually oriented. Emotional growth through letting go, spiritual practice, and accepting the impermanent.",
  },
  PK: {
    1: "Your Putrakaraka rules the 1st house — children and creativity are inseparable from your identity. Your creative intelligence defines who you are at the most fundamental level.",
    2: "Your Putrakaraka rules the 2nd house — children connect to family wealth. Creative intelligence applied to earning, speech, or preserving family values. Creative approach to finances.",
    3: "Your Putrakaraka rules the 3rd house — children are courageous and communicative. Your creativity expresses through writing, media, or entrepreneurial ventures.",
    4: "Your Putrakaraka rules the 4th house — children bring domestic happiness. Creative intelligence applied to home, education, and property. Academic achievement is favoured.",
    5: "Your Putrakaraka rules the 5th house — supremely auspicious for children, creativity, romance, and intelligence. Your creative powers are at their peak and children are a great blessing.",
    6: "Your Putrakaraka rules the 6th house — creative energy directed toward service, healing, or overcoming obstacles. Children may face challenges that ultimately build character.",
    7: "Your Putrakaraka rules the 7th house — children influence your partnerships. Creative approach to marriage and business. Spouse and children are closely interconnected themes.",
    8: "Your Putrakaraka rules the 8th house — deep, transformative experiences through children or creative work. Hidden creative talents. Research and occult creativity are possible.",
    9: "Your Putrakaraka rules the 9th house — children are fortunate and drawn to higher learning. Creative expression in philosophy, teaching, and dharmic pursuits. Speculative luck through wisdom.",
    10: "Your Putrakaraka rules the 10th house — children influence your career, or your career involves creativity and education. Your creative reputation builds your public standing.",
    11: "Your Putrakaraka rules the 11th house — gains through children and creative ventures. Ambitious creative projects succeed. Social network includes creative, intelligent individuals.",
    12: "Your Putrakaraka rules the 12th house — children may live abroad or be spiritually inclined. Creative expression through foreign, spiritual, or behind-the-scenes work.",
  },
  GK: {
    1: "Your Gnatikaraka rules the 1st house — obstacles directly target your health, body, and sense of self. Personal enemies and physical ailments are the main challenges to overcome.",
    2: "Your Gnatikaraka rules the 2nd house — obstacles arise through finances, family disputes, or speech-related conflicts. Debts and financial litigation require careful management.",
    3: "Your Gnatikaraka rules the 3rd house — obstacles through communication breakdowns, sibling rivalry, or failed initiatives. Enemies compete through media, writing, or business.",
    4: "Your Gnatikaraka rules the 4th house — obstacles in domestic peace, property disputes, or relationship with mother. Home environment may be a source of stress that requires resolution.",
    5: "Your Gnatikaraka rules the 5th house — challenges related to children, creative blocks, or romantic disappointment. Speculative ventures face obstacles. Education may be interrupted.",
    6: "Your Gnatikaraka rules the 6th house — powerfully placed to defeat enemies and overcome disease. Your obstacles become your strength. Excellence in competitive and service-oriented work.",
    7: "Your Gnatikaraka rules the 7th house — obstacles manifest through partnerships and marriage. Legal disputes, business rivalry, or marital conflict are karmic challenges to navigate.",
    8: "Your Gnatikaraka rules the 8th house — obstacles involve sudden crises, inheritance disputes, or health emergencies. Challenges are intense but transformative when overcome.",
    9: "Your Gnatikaraka rules the 9th house — obstacles in dharma, higher education, or relationship with father. Philosophical conflicts or disputes with teachers and religious institutions.",
    10: "Your Gnatikaraka rules the 10th house — obstacles in career and public standing. Professional enemies, authority conflicts, or reputation challenges must be navigated with persistence.",
    11: "Your Gnatikaraka rules the 11th house — obstacles in achieving ambitions or through social networks. Income fluctuations and false friends are challenges. Gains require overcoming resistance.",
    12: "Your Gnatikaraka rules the 12th house — obstacles through losses, foreign difficulties, or spiritual confusion. Expenses may be hard to control. Hidden enemies require awareness.",
  },
};
...
const NAISARGIKA_KARAKA_IN_HOUSE: Record<string, Record<number, string>> = {
  Sun: {
...
async function main() {
  console.log("Seeding karaka interpretations …");

  let count = 0;

  // 1. Chara Karaka Roles
  for (const role of CHARA_KARAKA_ROLES) {
    await prisma.interpretation.upsert({
      where: { category_key1_key2: { category: "chara_role", key1: role.id, key2: "" } },
      update: { content: role as any },
      create: { category: "chara_role", key1: role.id, key2: "", content: role as any },
    });
    count++;
  }

  // 2. Chara Karaka by Planet
  for (const [roleId, planets] of Object.entries(CHARA_KARAKA_BY_PLANET)) {
    for (const [planet, text] of Object.entries(planets)) {
      await prisma.interpretation.upsert({
        where: { category_key1_key2: { category: "chara_by_planet", key1: roleId, key2: planet } },
        update: { content: { text } as any },
        create: { category: "chara_by_planet", key1: roleId, key2: planet, content: { text } as any },
      });
      count++;
    }
  }

  // 3. Chara Karaka Lordship
  for (const [roleId, houses] of Object.entries(CHARA_KARAKA_LORDSHIP)) {
    for (const [house, text] of Object.entries(houses)) {
      await prisma.interpretation.upsert({
        where: { category_key1_key2: { category: "chara_lordship", key1: roleId, key2: String(house) } },
        update: { content: { text } as any },
        create: { category: "chara_lordship", key1: roleId, key2: String(house), content: { text } as any },
      });
      count++;
    }
  }

  // 4. Naisargika Karakas
  for (const nk of NAISARGIKA_KARAKAS) {
    await prisma.interpretation.upsert({
      where: { category_key1_key2: { category: "naisargika", key1: nk.planet, key2: "" } },
      update: { content: nk as any },
      create: { category: "naisargika", key1: nk.planet, key2: "", content: nk as any },
    });
    count++;
  }

  // 5. Naisargika Karaka in House
  for (const [planet, houses] of Object.entries(NAISARGIKA_KARAKA_IN_HOUSE)) {
    for (const [house, text] of Object.entries(houses)) {
      await prisma.interpretation.upsert({
        where: { category_key1_key2: { category: "naisargika_in_house", key1: planet, key2: String(house) } },
        update: { content: { text } as any },
        create: { category: "naisargika_in_house", key1: planet, key2: String(house), content: { text } as any },
      });
      count++;
    }
  }

  console.log(`Done — upserted ${count} interpretation rows.`);
}
