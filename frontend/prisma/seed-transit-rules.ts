...
const QUESTION_CATEGORIES: { id: string; keywords: string[]; houses: number[]; planets: string[] }[] = [
  ...
  { id: "family_dynamics", keywords: ["mother", "mom", "maa", "mata", "sister", "behen", "brother", "bhai", "sibling", "siblings", "parents", "father", "dad", "papa", "pita", "pitaji", "family", "joint family", "in-laws", "relatives", "ghar wale", "gharwale", "gharwalo"], houses: [4, 3, 9, 2], planets: ["Moon", "Jupiter", "Saturn", "Mars"] },
