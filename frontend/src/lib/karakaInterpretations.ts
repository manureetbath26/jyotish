...
// ---------------------------------------------------------------------------
// Chara Karaka Lordship — what it means when a karaka planet rules a house
// Keyed as [role_id][house_ruled] → specific interpretation
// ---------------------------------------------------------------------------
export const CHARA_KARAKA_LORDSHIP: Record<string, Record<number, string>> = {
  AK: {
